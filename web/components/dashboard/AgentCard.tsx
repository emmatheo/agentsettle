  ...
  return (
    <motion.div layout initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="glass glass-hover flex flex-col gap-4 p-5">
      <div className="flex items-start justify-between">
        ...
        <span className={`chip border-white/10 ${status.text}`}>
      ...
      <div className="rounded-lg border border-white/[0.07] bg-white/[0.015] p-3.5">
        ...
        <div className="mb-3 flex flex-wrap gap-2">
          ...
          <span className={`chip border-white/10 ${expiry.urgent ? "text-warn" : "text-mute"}`}>
        ...
        <div>
          ...
          <span className="chip border-white/10 text-mute">{s.owner ? short(s.owner) : "—"}</span>
        </div>
      </div>
